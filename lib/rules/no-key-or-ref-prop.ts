...
const rule = createRule<Options, MessageIds>({
  ...
  meta: {
    ...
    messages: {
      "no-key-or-ref-prop":
        "Do not use `key` or `ref` as prop names, as they won't work expectedly with React; rename them to something else or use forwardRef() instead.",
    },
    type: "problem",
    schema: [],
  },
